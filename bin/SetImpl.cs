// Dafny program SetImpl.dfy compiled into C#
...
// Command-line arguments: translate cs --include-runtime SetImpl.dfy
// SetImpl.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static Dafny.ISet<BigInteger> CreateS1()
    {
      ...
      for (BigInteger _1_i = BigInteger.Zero; _1_i < _hi0; _1_i++) {
        s1 = Dafny.Set<BigInteger>.Union(s1, Dafny.Set<BigInteger>.FromElements((_1_i) * (new BigInteger(62))));
      }
      BigInteger _hi1 = new BigInteger(100);
      for (BigInteger _2_i = BigInteger.Zero; _2_i < _hi1; _2_i++) {
        s1 = Dafny.Set<BigInteger>.Union(s1, Dafny.Set<BigInteger>.FromElements(((new BigInteger(4)) * (__default.Exp(new BigInteger(2), new BigInteger(16)))) + (_2_i)));
      }
      BigInteger _hi2 = __default.Exp(new BigInteger(2), new BigInteger(15));
      for (BigInteger _3_i = BigInteger.Zero; _3_i < _hi2; _3_i++) {
        s1 = Dafny.Set<BigInteger>.Union(s1, Dafny.Set<BigInteger>.FromElements(((new BigInteger(100)) * (__default.Exp(new BigInteger(2), new BigInteger(16)))) + ((_3_i) * (new BigInteger(2)))));
      }
      return s1;
    }
    public static Dafny.ISet<BigInteger> CreateS2()
    {
      ...
      for (BigInteger _4_i = BigInteger.Zero; _4_i < _hi3; _4_i++) {
        s2 = Dafny.Set<BigInteger>.Union(s2, Dafny.Set<BigInteger>.FromElements((_4_i) * (new BigInteger(31))));
      }
      BigInteger _hi4 = new BigInteger(100);
      for (BigInteger _5_i = BigInteger.Zero; _5_i < _hi4; _5_i++) {
        s2 = Dafny.Set<BigInteger>.Union(s2, Dafny.Set<BigInteger>.FromElements(((new BigInteger(5)) * (__default.Exp(new BigInteger(2), new BigInteger(16)))) + (_5_i)));
      }
      BigInteger _hi5 = __default.Exp(new BigInteger(2), new BigInteger(15));
      for (BigInteger _6_i = BigInteger.Zero; _6_i < _hi5; _6_i++) {
        s2 = Dafny.Set<BigInteger>.Union(s2, Dafny.Set<BigInteger>.FromElements(((new BigInteger(100)) * (__default.Exp(new BigInteger(2), new BigInteger(16)))) + (((_6_i) + (BigInteger.One)) * (new BigInteger(2)))));
      }
      return s2;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.ISet<BigInteger> _7_s1;
      Dafny.ISet<BigInteger> _out0;
      _out0 = __default.CreateS1();
      _7_s1 = _out0;
      Dafny.ISet<BigInteger> _8_s2;
      Dafny.ISet<BigInteger> _out1;
      _out1 = __default.CreateS2();
      _8_s2 = _out1;
      Dafny.ISet<BigInteger> _9_sUnion;
      _9_sUnion = Dafny.Set<BigInteger>.Union(_7_s1, _8_s2);
    }
  }
  ...
  public partial class nat32 {
    ...
    public static bool _Is(BigInteger __source) {
      BigInteger _10_n = __source;
      return ((_10_n).Sign != -1) && ((_10_n) < (__default.Exp(new BigInteger(2), new BigInteger(32))));
    }
  }
